# create_advanced_grafted_model_v3.py
...
def create_advanced_grafted_model(path_0, path_20):
    ...
    # ======================================================================
    #  !!! 关键修复 !!!
    #  根据您的原始代码结构，正确地对 orthogonal_procrustes 的返回值进行元组解包。
    # ======================================================================
    R_v, _ = orthogonal_procrustes(V0, V20)
    v_similarity = diagnose_alignment("V", V0, V20, R_v)
    
    R_u, _ = orthogonal_procrustes(U0, U20)
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("     🚀 开始执行高级“双重对齐嫁接”实验 (v3 - 最终修复版) 🚀     ")
    ...
    try:
        ...
        # 使用新的、更清晰的文件名
        output_filename = os.path.join(output_dir, f"hybrid_advanced_v3_seed{SEED_TO_TEST}.pt")
